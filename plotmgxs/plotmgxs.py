...
nufission_fuel = xs_library[fuel.id]['nu-fission']
nufission_fuel_xs = nufission_fuel.get_xs()
energy_bounds=XMAS172
print(nufission_fuel_xs)

fig, ax = plt.subplots()
ax.step(energy_bounds[:-1], nufission_fuel_xs, where='post', label='XMAS-172') 
ax.set_xscale('log')
ax.set_yscale('log')
...
#nufission.print_xs(xs_type='macro')
